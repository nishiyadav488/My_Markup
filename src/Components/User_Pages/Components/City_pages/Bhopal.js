	...
	return(
		<div id="Bhopal">
			...
			<div id="content_bhopal">
				<CityCard img={Bhopal1} head="Nature Courtyard" text={hotel6.about}location={hotel6.location} price={hotel1.price}/><br/>
				<CityCard img={Bhopal2} head="Woods Inn Resort" text={hotel6.about}location={hotel6.location} price={hotel2.price}/><br/>
				<CityCard img={Bhopal3} head="Madhuban Resort" text={hotel6.about} location={hotel6.location} price={hotel3.price}/><br/>
				<CityCard img={Bhopal4} head="Holiday Homes Aand Resort" text={hotel6.about}location={hotel6.location} price={hotel4.price}/><br/>
				<CityCard img={Bhopal5} head="Villa De Casa, Bhopal" text={hotel6.about}location={hotel6.location} price={hotel5.price}/><br/>
				<CityCard img={Bhopal6} head="Laal Kothi,Bhopal" text={hotel6.about}location={hotel6.location} price={hotel6.price}/>
			</div></div>
			<Footer/>
		</div>
	)
